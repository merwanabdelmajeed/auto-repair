...
// complete list. Used where a screen needs the full data set client-side
// (cross-reference maps, date-based filtering that can't assume any
// particular page ordering) rather than true incremental/infinite-scroll
// loading — the network payload is still chunked per request either way.
