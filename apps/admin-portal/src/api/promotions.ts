...
export const updatePromotion = (promoId: string, data: Partial<{ description: string; isActive: boolean; type: 'percent' | 'fixed'; value: number; expiresAt: string | null; maxUses: number | null }>) =>
