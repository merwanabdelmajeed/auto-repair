...
describe('Header', () => {
  it('renders the title', () => {
    render(<NavigationContainer><Header title="Home" /></NavigationContainer>);
  ...
  it('renders a custom rightElement when provided', () => {
    render(<NavigationContainer><Header title="Home" rightElement={<Text>Right</Text>} /></NavigationContainer>);
